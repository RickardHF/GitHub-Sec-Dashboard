...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-80px)] p-4">
      <div className="w-full max-w-md p-8 space-y-8 bg-white dark:bg-gray-900 rounded-lg shadow-md border border-gray-200 dark:border-gray-800 transition-colors">
        ...
        <div className="mt-8">
          <button
            ...
            disabled={isLoading}
            className="flex w-full justify-center items-center px-4 py-3 space-x-2 text-white bg-black dark:bg-gray-800 rounded-md hover:bg-gray-800 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black dark:focus:ring-gray-600 disabled:opacity-70 transition-colors"
          >
            {isLoading ? (
